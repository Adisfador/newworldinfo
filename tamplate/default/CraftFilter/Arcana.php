...
<div class="Craft">
    ...
    <div class="Craft__item Craft__item--second ">
        ...
        // Второй фильтр
        echo '<a class="' . $class . $SecondActive1 .  '" href="' . $Arcanaadress . '&page=' . "1" . '&Filter=' . $F . '&Filter2=' . "Second1"  . '&Filter3=' .  Get__Filter3()  .  '">' . 'Все слоты' . '</a> ';
        echo '<a class="' . $class . $SecondActive2 .  '" href="' . $Arcanaadress . '&page=' . "1"  . '&Filter=' . $F . '&Filter2=' . "Second2" . '&Filter3=' .  Get__Filter3()  .  '">' . 'Зелья' . '</a> ';
        echo '<a class="' . $class . $SecondActive3 .  '" href="' . $Arcanaadress . '&page=' . "1" . '&Filter=' . $F . '&Filter2=' . "Second3"  . '&Filter3=' .  Get__Filter3()  .  '">' . 'Микстуры' . '</a> ';
        echo '<a class="' . $class . $SecondActive4 .  '" href="' . $Arcanaadress . '&page=' . "1"  . '&Filter=' . $F . '&Filter2=' . "Second4" . '&Filter3=' .  Get__Filter3()  .  '">' . 'Ледяная перчатка' . '</a> ';
        echo '<a class="' . $class . $SecondActive5 .  '" href="' . $Arcanaadress . '&page=' . "1" . '&Filter=' . $F . '&Filter2=' . "Second5"  . '&Filter3=' .  Get__Filter3()  .  '">' . 'Посох огня' . '</a> ';
        echo '<a class="' . $class . $SecondActive6 .  '" href="' . $Arcanaadress . '&page=' . "1"  . '&Filter=' . $F . '&Filter2=' . "Second6" . '&Filter3=' .  Get__Filter3()  .  '">' . 'Посох жизни' . '</a> ';
    ...
    <div class="Craft__item">
        <div class="Craft__box">
            ...
            // Третий фильтр
            echo '<a class="' . $class . $ThirdActive1 .  '" href="' . $Arcanaadress . '&page=' . "1" . '&Filter=' . $F . '&Filter2=' . Get__Filter2()  . '&Filter3=' .  "Third1"  .  '">' . 'Все грейды' . '</a> ';
            echo '<a class="' . $class . $ThirdActive2 .  '" href="' . $Arcanaadress . '&page=' . "1"  . '&Filter=' . $F . '&Filter2=' . Get__Filter2() . '&Filter3=' .  "Third2"  .  '">' . 'Г2' . '</a> ';
            echo '<a class="' . $class . $ThirdActive3 .  '" href="' . $Arcanaadress . '&page=' . "1" . '&Filter=' . $F . '&Filter2=' . Get__Filter2()  . '&Filter3=' .  "Third3"  .  '">' . 'Г3' . '</a> ';
            echo '<a class="' . $class . $ThirdActive4 .  '" href="' . $Arcanaadress . '&page=' . "1"  . '&Filter=' . $F . '&Filter2=' . Get__Filter2() . '&Filter3=' .  "Third4"  .  '">' . 'Г4' . '</a> ';
            echo '<a class="' . $class . $ThirdActive5 .  '" href="' . $Arcanaadress . '&page=' . "1"  . '&Filter=' . $F . '&Filter2=' . Get__Filter2() . '&Filter3=' .  "Third5"  .  '">' . 'Г5' . '</a> ';
...
<div class="Tablecraft">
    <div class="Tablecraft__rows">
        ...
        if ($_GET['Filter5'] == "FifthUP1" xor $_GET['Filter5'] == "FifthUP2" xor $_GET['Filter5'] == "FifthUP3" xor $_GET['Filter5'] == "FifthUP4" xor $_GET['Filter5'] == "FifthUP5" xor $_GET['Filter5'] == "FifthUP6") {
            ...
            echo '<a class="' . $class2 . $FifthActive1 .   '" href="' . $Arcanaadress . '&page=' . "1" . '&Filter=' . $F . '&Filter2=' .  $F2  . '&Filter3=' .  Get__Filter3()   . '&Filter5=' . "FifthDown1" . '">' . 'Название' . '</a> ';
            echo '<a class="' . $class2 . $FifthActive2 .   '" href="' . $Arcanaadress . '&page=' . "1" . '&Filter=' . $F . '&Filter2=' .  $F2  . '&Filter3=' .  Get__Filter3()   . '&Filter5=' . "FifthDown2" . '">' . 'Категория' . '</a> ';
            // echo '<a class="' . $class2 . $FifthActive3 .   '" href="' . $Arcanaadress . '&page=' . "1" . '&Filter=' . $F . '&Filter2=' .  $F2  . '&Filter3=' .  Get__Filter3()   . '&Filter5=' . "FifthDown3" . '">' . 'Подкатегория' . '</a> ';
        
            echo '<a class="' . $class2 . $FifthActive4 .   '" href="' . $Arcanaadress . '&page=' . "1" . '&Filter=' . $F . '&Filter2=' .  $F2  . '&Filter3=' .  Get__Filter3()   . '&Filter5=' . "FifthDown4" . '">' . 'Грейд' . '</a> ';
            ?>
            <div class="Tablecraft__link">Ингридиенты</div>
        <?php
            echo '<a class="' . $class2 . $FifthActive5 .   '" href="' . $Arcanaadress . '&page=' . "1" . '&Filter=' . $F . '&Filter2=' .  $F2  . '&Filter3=' .  Get__Filter3()   . '&Filter5=' . "FifthDown5" . '">' . 'Уровень' . '</a> ';
            ?>
        ...
        <?php
            ...
            $class2 = "Tablecraft__link table__link-undreline";
            echo '<a class="' . $class2 . $FifthActive1 .   '" href="' . $Arcanaadress . '&page=' . "1" . '&Filter=' . $F . '&Filter2=' .  $F2  . '&Filter3=' .  Get__Filter3()   . '&Filter5=' . "FifthUP1" . '">' . 'Название' . '</a> ';
            echo '<a class="' . $class2 . $FifthActive2 .   '" href="' . $Arcanaadress . '&page=' . "1" . '&Filter=' . $F . '&Filter2=' .  $F2  . '&Filter3=' .  Get__Filter3()   . '&Filter5=' . "FifthUP2" . '">' . 'Категория' . '</a> ';
            // echo '<a class="' . $class2 . $FifthActive3 .   '" href="' . $Arcanaadress . '&page=' . "1" . '&Filter=' . $F . '&Filter2=' .  $F2  . '&Filter3=' .  Get__Filter3()   . '&Filter5=' . "FifthUP3" . '">' . 'Подкатегория' . '</a> ';
          
            echo '<a class="' . $class2 . $FifthActive4 .   '" href="' . $Arcanaadress . '&page=' . "1" . '&Filter=' . $F . '&Filter2=' .  $F2  . '&Filter3=' .  Get__Filter3()   . '&Filter5=' . "FifthUP4" . '">' . 'Грейд' . '</a> ';
            ?>
            <div class="Tablecraft__link">Ингридиенты</div>
        <?php
            echo '<a class="' . $class2 . $FifthActive5 .   '" href="' . $Arcanaadress . '&page=' . "1" . '&Filter=' . $F . '&Filter2=' .  $F2  . '&Filter3=' .  Get__Filter3()   . '&Filter5=' . "FifthUP5" . '">' . 'Уровень' . '</a> ';
            ?>
            <div class="Tablecraft__link">Опыт изготовления</div>
        <?php
        }
    ...
    if ($F2 == "Second1") {
        ...
        $SelectFilter2 = 'Card_Class LIKE  "%Potion%"';
    } else if ($F2 == "Second3") {
        $SelectFilter2 = 'Card_Class LIKE "%Weapon Oil%"';
    } else if ($F2 == "Second4") {
        $SelectFilter2 = 'Card_Class LIKE "%Ice Gauntlet%"';
    } else if ($F2 == "Second5") {
        $SelectFilter2 = 'Card_Class  LIKE "%Fire Staff%"';
    } else if ($F2 == "Second6") {
        $SelectFilter2 = 'Card_Class  LIKE "%Life Staff%"';
    } 
