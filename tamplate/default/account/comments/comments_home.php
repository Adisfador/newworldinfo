...
$result = mysqli_query(table(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME), "INSERT INTO `comments_home` (`id`, `login`, `time`, `comment` , `build_name`) VALUES (NULL, '$login', '$com_time', '$text_comment' ,'$build');");
...
<script type="text/javascript">
    location = '/index.php?&AdressMain=Home&calc_weapon=true&calc_random=<? echo ($build); ?>&send=<? echo ($send); ?>';
</script>
